...
$_SESSION['profile_picture']   = "<div class='profile_picture thumbnail' style='background-image: url(\"/images/user_profiles/" . $profile_row['filename'] . "\"); background-position:".$profile_row['x'].'% '.$profile_row['y']."%;'></div>";
